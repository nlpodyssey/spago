...
func NewSparse(rows, cols int, elements []Float) *Sparse {
	if elements == nil {
		panic("mat64: elements cannot be nil. Use NewEmptySparse() instead.")
	}
...
func NewVecSparse(elements []Float) *Sparse {
	if elements == nil {
		panic("mat64: elements cannot be nil. Use NewEmptyVecSparse() instead.")
	}
...
func (s *Sparse) OnesLike() Matrix {
	panic("mat64: OnesLike not implemented for Sparse matrices")
}
...
func (s *Sparse) AddInPlace(other Matrix) Matrix {
	...
	default:
		panic("mat64: AddInPlace(Dense) not implemented for Sparse matrices")
	}
	return s
}
...
func (s *Sparse) SubInPlace(other Matrix) Matrix {
	...
	case *Sparse:
		...
		s.nzElements = result.nzElements
	default:
		panic("mat64: SubInPlace(Dense) not implemented for Sparse matrices")
	}
	return s
}
...
func (s *Sparse) ProdInPlace(other Matrix) Matrix {
	...
	case *Sparse:
		...
		s.nzElements = result.nzElements
	default:
		panic("mat64: ProdInPlace(Dense) not implemented for Sparse matrices")
	}
	return s
}
...
func (s *Sparse) SplitV(_ ...int) []Matrix {
	panic("mat64: SplitV not implemented for Sparse matrices")
}

// MulT is currently not implemented for a Sparse matrix (it always panics).
func (s *Sparse) MulT(_ Matrix) Matrix {
	panic("mat64: MulT not implemented for Sparse matrices")
}

// Inverse returns the inverse of the matrix.
func (s *Sparse) Inverse() Matrix {
	panic("mat64: Sparse not implemented for Sparse matrices")
}
...
func (s *Sparse) Maximum(other Matrix) Matrix {
	...
	default:
		panic("mat64: Maximum not implemented between Dense and Sparse matrices")
	}
}
...
func (s *Sparse) Minimum(other Matrix) Matrix {
	...
	default:
		panic("mat64: Minimum not implemented between Dense and Sparse matrices")
	}
}
