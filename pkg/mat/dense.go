...
import (
	...
	"github.com/nlpodyssey/spago/pkg/mat/internal/f32/asm32"
	"github.com/nlpodyssey/spago/pkg/mat/internal/f64"
...
func (d *Dense[T]) Prod(other Matrix[T]) Matrix[T] {
	if !(d.SameDims(other) || (d.IsVector() && other.IsVector() && other.Size() == d.Size())) {
