...
func TestModel_Forward(t *testing.T) {
	...
	x1 := g.NewVariable(mat.NewDense(2, 4, []mat.Float{
		0.2, 0.1, 0.5, 0.8,
		0.4, -0.3, -0.2, -0.3,
	}), true)

	x2 := g.NewVariable(mat.NewDense(2, 4, []mat.Float{
		-0.2, 0.1, 0.5, 0.8,
		0.4, -0.3, -0.2, -0.9,
	}), true)

	x3 := g.NewVariable(mat.NewDense(2, 4, []mat.Float{
		0.2, 0.5, 0.9, 0.8,
		0.4, -0.5, -0.3, -0.2,
	}), true)
	...
	y[0].PropagateGrad(mat.NewDense(1, 3, []mat.Float{
		-0.3, 0.5, 0.6,
	}))

	y[1].PropagateGrad(mat.NewDense(1, 3, []mat.Float{
		-0.3, 0.5, -0.6,
	}))
