...
func TestClipValue(t *testing.T) {
	...
	assert.InDeltaSlice(t, []float64{0.7, 0.7, 0.4, 0.7, 0.1}, gs[1].Data(), 1.0e-05)
}
...
func TestClip2Norm(t *testing.T) {
	...
	assert.InDeltaSlice(t, []float64{0.566665, 0.440739, 0.251851, 0.503702, 0.062962}, gs[1].Data(), 1.0e-06)
}
...
func TestClipNormInf(t *testing.T) {
	...
	assert.InDeltaSlice(t, []float64{0.45, 0.35, 0.2, 0.4, 0.05}, gs[1].Data(), 1.0e-06)
}
