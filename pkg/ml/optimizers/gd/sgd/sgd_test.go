...
func TestSGD_Update(t *testing.T) {
	...
	assert.InDeltaSlice(t, []float64{0.3991, 0.3993, 0.4996, 0.9992, 0.7999}, params.Data(), 1.0e-6)
}
...
func TestSGDMomentum_Update(t *testing.T) {
	...
	assert.InDeltaSlice(t, []float64{-0.2309, -0.3207, 0.0496, 0.7292, 0.6199}, params.Data(), 1.0e-6)
}
...
func TestSGDNesterovMomentum_Update(t *testing.T) {
	...
	assert.InDeltaSlice(t, []float64{-0.16871, -0.24933, 0.09424, 0.75548, 0.63781}, params.Data(), 1.0e-6)
}
