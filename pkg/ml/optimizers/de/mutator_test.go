...
func TestRandomMutator(t *testing.T) {
	...
	assert.InDeltaSlice(t, []float64{0.85, -0.1, 2.1, 0.2, 2.85}, population.Members[0].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-0.95, 1.8, 0.05, -3.3, -2.25}, population.Members[1].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-1.7, 0.75, -2.1, 2.0, -1.1}, population.Members[2].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-1.45, 0.85, -0.25, -2.7, -1.9}, population.Members[3].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-2.1, 0.95, 0.45, 0.0, 2.2}, population.Members[4].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{2.95, -0.8, 1.65, -0.4, 1.1}, population.Members[5].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-1.5, -0.9, -0.5, 0.25, 0.6}, population.Members[6].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{4.7, -2.7, 2.25, 2.75, 3.05}, population.Members[7].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-1.55, 0.15, -1.45, 1.15, -0.65}, population.Members[8].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-0.9, -2.1, -1.35, 4.7, 1.3}, population.Members[9].DonorVector.Data(), 0.0001)
}
...
func TestDeglMutator(t *testing.T) {
	...
	assert.InDeltaSlice(t, []float64{-1.35, 0.05, 0.15, 1.075, 1.875}, population.Members[0].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-0.975, -0.7, 0.65, -0.35, 2.3}, population.Members[1].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{1.4, -2.025, 1.05, 1.625, 2.2}, population.Members[2].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{1, -0.375, 0.575, 1.275, 1.625}, population.Members[3].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-0.9, -1.675, 0.95, -1.4, 2.425}, population.Members[4].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-0.85, -0.05, 0.525, -2.5, -0.4}, population.Members[5].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-1.125, 0.725, 0.75, -3.525, -0.7}, population.Members[6].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{1.025, -2.375, 0.15, 3.175, 2.225}, population.Members[7].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{1.15, -0.3, 0.05, 0.325, 0.425}, population.Members[8].DonorVector.Data(), 0.0001)
	assert.InDeltaSlice(t, []float64{-0.275, -0.625, -0.675, 0.075, 0.175}, population.Members[9].DonorVector.Data(), 0.0001)
}
