...
func testMSELoss[T mat.DType](t *testing.T) {
	x := ag.NewVariable(mat.NewVecDense([]T{0.0, 0.1, 0.2, 0.3}), true)
	y := ag.NewVariable(mat.NewVecDense([]T{0.3, 0.2, 0.1, 0.0}), false)
	loss := MSE(x, y, false)
...
func testNLLLoss[T mat.DType](t *testing.T) {
	x := ag.NewVariable(mat.NewVecDense([]T{-0.8, 0.1, 0.693147, 1.94591}), true)
	y := ag.NewVariable(mat.NewVecDense([]T{0.0, 0.0, 1.0, 0.0}), false)
...
func testZeroOneQuantization[T mat.DType](t *testing.T) {
	x := ag.NewVariable(mat.NewVecDense([]T{0.1, 0.2, 1.0, 0.4, -0.8, 0.3}), true)
...
func testMSESeqLoss[T mat.DType](t *testing.T) {
	x1 := ag.NewVariable(mat.NewVecDense([]T{0.0, 0.1, 0.2, 0.3}), true)
	y1 := ag.NewVariable(mat.NewVecDense([]T{0.3, 0.2, 0.1, 0.0}), false)
	x2 := ag.NewVariable(mat.NewVecDense([]T{0.0, 0.1, 0.2, 0.3}), true)
	y2 := ag.NewVariable(mat.NewVecDense([]T{0.3, 0.2, 0.1, 0.0}), false)
