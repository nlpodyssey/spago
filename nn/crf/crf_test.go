...
func testModelDecode[T float.DType](t *testing.T) {
	...
	w1 := mat.NewDense[T](mat.WithBacking([]T{1.7, 0.2, -0.3, 0.5}), mat.WithGrad(true))
	w2 := mat.NewDense[T](mat.WithBacking([]T{2.0, -3.5, 0.1, 2.0}), mat.WithGrad(true))
	w3 := mat.NewDense[T](mat.WithBacking([]T{-2.5, 3.2, -0.2, -0.3}), mat.WithGrad(true))
	w4 := mat.NewDense[T](mat.WithBacking([]T{3.3, -0.9, 2.7, -2.7}), mat.WithGrad(true))
	w5 := mat.NewDense[T](mat.WithBacking([]T{0.5, 0.2, 0.4, 1.4}), mat.WithGrad(true))
